...
category1 = Category.create!(:en_name=>"Cat 1", :zh_cn_name=>"扬声器", :position=>1)
category1_1 = Category.create!(:en_name=>"sub 1-1",:zh_cn_name=>"彩电扬声器",:parent=> category1)
...
category2 =Category.create!(:en_name=>"Cat 2", :zh_cn_name=>"电器设备", :position=>2)
...
category3 =Category.create!(:en_name=>"Cat 3", :zh_cn_name=>"音响系统", :position=>3)
